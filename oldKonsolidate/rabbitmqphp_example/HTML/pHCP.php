...
<div id="title">
	...
	<form action = "UploadProcess.php" method = "post" enctype = "multipart/form-data">
		Select a file: <input class="btn btn-lg btn-primary btn-block" type = "file" name = "myFile" id = "myFile"><br><br>
	...
	<form action = "viewReports.php" method = "get">
		<br><input class="btn btn-lg btn-primary btn-block" type = submit value = "Reports" name = "reports">
	</form>

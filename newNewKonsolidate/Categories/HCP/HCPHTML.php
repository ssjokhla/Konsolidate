...
<?php
if(gateKeeperLogin("/var/Konsolidate/Categories/Sessions/login.html") && gateKeeperRole("/var/Konsolidate/Categories/Sessions/login.html", "hcp")){
?>
<!DOCTYPE html>
<html lang="en">
<div class="content">
...
<div id="title">
	<h1 style="color: white;"><strong>H C P<strong></h1>
	  ...
	  <div id="login">
	<form action = "/var/Konsolidate/Categories/Upload/UploadProcess.php" method = "post" enctype = "multipart/form-data">
	...
	<form action = "/var/Konsolidate/Categories/View/viewReports.php" method = "get">
